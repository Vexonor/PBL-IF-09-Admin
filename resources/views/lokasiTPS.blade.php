...
<div class="grid grid-cols-2 mb-5">
    <div class="col-span-1">
        <button type="button"
            class="py-3 px-4 w-52 2xl:w-max justify-center inline-flex items-center gap-x-2 text-sm 2xl:text-base font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
    ...
    <form class="flex justify-end w-full gap-4" id="filterForm">
        ...
        <div class="max-w-xs">
            <select
                class="py-3 px-4 pe-9 max-w-xs block border-gray-200 rounded-lg text-sm 2xl:text-base focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
        ...
        <div class="w-52 2xl:w-max">
            ...
            "optionClasses": "py-2 px-4 w-full text-sm 2xl:text-base text-gray-800 cursor-pointer hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800",
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    <thead class="bg-Genoa text-white">
                        <tr>
                            ...
                            <th scope="col"
                                ...
                                Status TPS</th>
                            <th scope="col"
                                class="px-6 py-3 text-center text-xs 2xl:text-sm font-medium uppercase dark:text-neutral-500">
                                Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700 text-center">
                        ...
                        <tr class="hover:bg-gray-100">
                            <td
                                class="px-6 py-4 whitespace-nowrap text-sm 2xl:text-base border-r-2 font-medium text-gray-800 dark:text-neutral-200">
                                {{ $key +1 }}.
                            </td>
                            <td
                                class="px-6 py-4 whitespace-nowrap text-sm 2xl:text-base border-r-2 text-gray-800 dark:text-neutral-200">
                                {{ $TPS->Kode_TPS }}
                            </td>
                            <td
                                class="px-6 py-4 whitespace-nowrap text-sm 2xl:text-base border-r-2 text-gray-800 dark:text-neutral-200">
...
<button type="button"
    class="py-3 px-4 my-10 w-max justify-center inline-flex items-center gap-x-2 text-sm 2xl:text-base font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
