...
<div class="grid grid-cols-2 mb-5">
    <div class="col-span-1">
        <button type="button"
            class="py-3 px-4 w-52 justify-center inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
                    ...
                    <thead class="bg-Genoa text-white">
                        <tr>
                            ...
                            <th scope="col"
                                ...
                                Status TPS</th>
                            <th scope="col"
                                class="px-6 py-3 text-center text-xs font-medium uppercase dark:text-neutral-500">
                                Aksi</th>
                        </tr>
                    </thead>
...
<button type="button"
    class="py-3 px-4 my-10 w-max justify-center inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
