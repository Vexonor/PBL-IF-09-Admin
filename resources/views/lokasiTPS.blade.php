...
@section('main')
    <button type="button"
        class="py-3 px-4 my-10 w-52 justify-center inline-flex items-center white-space: nowrap; gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
                ...
                <div class="overflow-hidden border dark:border-neutral-700">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                        <thead>
                            <tr>
                                <th scope="col"
                                    class="px-6 py-3 text-xs font-medium text-center text-white uppercase dark:text-neutral-500 bg-Genoa">
                                    Kode TPS</th>
                                <th scope="col"
                                    class="px-6 py-3 text-xs font-medium text-center text-white uppercase dark:text-neutral-500 bg-Genoa">
                                    Wilayah TPS</th>
    ...
    <button type="button"
        class="py-3 px-4 my-10 w-76 justify-center inline-flex items-center white-space: nowrap; gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
                        ...
                        <tbody class="text-center divide-y divide-gray-200 dark:divide-neutral-700">
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200"><span
                                        class="inline-flex border-2 border-Brick-Red items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-red-100 text-Brick-Red dark:bg-blue-800/30 dark:text-blue-500">
                                        <span
                                            class="size-1.5 inline-block rounded-lg bg-Brick-Red  dark:bg-blue-500"></span>
                                        Belum Selesai
                                    </span></td>
                                <td class="px-6 py-4 text-sm font-medium text-center whitespace-nowrap">
                                    <button type="button"
                    ...
                    <div class="w-full mb-5">
                        ...
                        <div class="w-full mt-5">
                            ...
                            <div class="relative" data-hs-combo-box="">
                                <div class="relative">
                                    <input
                                        class="block w-full py-3 text-sm border-2 rounded-lg ps-4 pe-9 border-slate-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        type="text" role="combobox" aria-expanded="false" value="Batam Kota"
                                        data-hs-combo-box-input="">
                                    <div class="absolute -translate-y-1/2 top-1/2 end-3" aria-expanded="false"
                                ...
                                <div class="absolute z-50 w-full max-h-72 p-1 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-900 dark:border-neutral-700"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        ...
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Batam Kota"
                                                data-hs-combo-box-value="">Batam Kota</span>
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        ...
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Batu Aji" data-hs-combo-box-value="">Batu
                                                Aji</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        ...
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Batu Ampar"
                                                data-hs-combo-box-value="">Batu Ampar</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        ...
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="B. Padang" data-hs-combo-box-value="">B.
                                                Padang</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Bengkong"
                                                data-hs-combo-box-value="">Bengkong</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Bulang"
                                                data-hs-combo-box-value="">Bulang</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Galang"
                                                data-hs-combo-box-value="">Galang</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Lubuk Baja"
                                                data-hs-combo-box-value="">Lubuk Baja</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Nongsa"
                                                data-hs-combo-box-value="">Nongsa</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Sagulung"
                                                data-hs-combo-box-value="">Sagulung</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Sei Beduk" data-hs-combo-box-value="">Sei
                                                Beduk</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                        tabindex="3" data-hs-combo-box-output-item="">
                                        <div class="flex items-center justify-between w-full">
                                            <span data-hs-combo-box-search-text="Sekupang"
                                                data-hs-combo-box-value="">Sekupang</span>
                                            <span class="hidden hs-combo-box-selected:block">
                                                <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <!-- <div class="w-full mt-5">
                            <label for="input-label" class="block mb-2 text-sm font-medium dark:text-white">Titik
                                Koordinat :</label>
                            <div class="max-w-sm space-y-3">
                                <input type="text" class="block w-full py-3 text-sm border-2 rounded-lg ps-4 pe-9 border-slate-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Masukkan Kode TPS">
                            </div> -->
                        <!-- Titik Koordinat -->

                        <!-- Status Pengangkutan -->
                        <div class="w-full mt-5">
                            <label for="input-label" class="block mb-2 text-sm font-medium dark:text-white">Status TPS
                                :</label>
                    ...
                    <div class="p-4 overflow-y-auto">
                        <div class="space-y-4">
                            <form action="">
                                ...
                                <div class="w-full mb-5">
                                    ...
                                    <div class="relative" data-hs-combo-box="">
                                        <div class="relative">
                                            <input
                                                class="block w-full py-3 text-sm border-2 rounded-lg ps-4 pe-9 border-slate-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                type="text" role="combobox" aria-expanded="false" value="TPS 01"
                                                data-hs-combo-box-input="">
                                            <div class="absolute -translate-y-1/2 top-1/2 end-3" aria-expanded="false"
                                                data-hs-combo-box-toggle="">
                                                <svg class="shrink-0 size-3.5 text-gray-500 dark:text-neutral-500"
                                        ...
                                        <div class="absolute z-50 w-full max-h-72 p-1 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-900 dark:border-neutral-700"
                                            ...
                                            <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                                tabindex="0" data-hs-combo-box-output-item="">
                                                <div class="flex items-center justify-between w-full">
                                                    <span data-hs-combo-box-search-text="TPS 01"
                                                        data-hs-combo-box-value="">TPS 01</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                            ...
                                            <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                                tabindex="1" data-hs-combo-box-output-item="">
                                                <div class="flex items-center justify-between w-full">
                                                    <span data-hs-combo-box-search-text="TPS 02"
                                                        data-hs-combo-box-value="">TPS 02</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                                tabindex="2" data-hs-combo-box-output-item="">
                                                <div class="flex items-center justify-between w-full">
                                                    <span data-hs-combo-box-search-text="TPS 03"
                                                        data-hs-combo-box-value="">TPS 03</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                                tabindex="3" data-hs-combo-box-output-item="">
                                                <div class="flex items-center justify-between w-full">
                                                    <span data-hs-combo-box-search-text="TPS 04"
                                                        data-hs-combo-box-value="">TPS 04</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                                tabindex="3" data-hs-combo-box-output-item="">
                                                <div class="flex items-center justify-between w-full">
                                                    <span data-hs-combo-box-search-text="TPS 05"
                                                        data-hs-combo-box-value="">TPS 05</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                                tabindex="3" data-hs-combo-box-output-item="">
                                                <div class="flex items-center justify-between w-full">
                                                    <span data-hs-combo-box-search-text="TPS 06"
                                                        data-hs-combo-box-value="">TPS 06</span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <div class="relative" data-hs-combo-box="">
                                        ...
                                        <div class="absolute z-50 w-full max-h-72 p-1 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-900 dark:border-neutral-700"
                                            ...
                                            <div class="w-full px-4 py-2 text-sm text-gray-800 rounded-lg cursor-pointer hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200 dark:focus:bg-neutral-800"
                                                tabindex="0" data-hs-combo-box-output-item="">
                                                <div class="flex items-center justify-between w-full">
                                                    <span data-hs-combo-box-search-text=""
                                                        data-hs-combo-box-value=""></span>
                                                    <span class="hidden hs-combo-box-selected:block">
                                                        <svg class="shrink-0 size-3.5 text-blue-600 dark:text-blue-500"
                                                            xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="w-full mt-5">
                                    <label for="input-label"
                                        class="block mb-2 text-sm font-medium dark:text-white">Status TPS :</label>
                ...
                <div
                    ...
                    <div class="p-4 overflow-y-auto">
                        <div class="space-y-4">
                            <!-- Wilayah -->
                            <div class="w-full mb-5">
                                <label for="input-label" class="block mb-2 text-sm font-medium dark:text-white">Kode TPS
                                    :</label>
                                <div class="relative" data-hs-combo-box="">
                                    <div class="relative">
                                        <input
                            ...
                            <!-- Petugas -->
                            <div class="w-full mb-5">
                                <label for="input-label" class="block mb-2 text-sm font-medium dark:text-white">Petugas
                                    Yang Bertanggung Jawab :</label>
                                <div class="relative" data-hs-combo-box="">
                                    <div class="relative">
                                        <input
