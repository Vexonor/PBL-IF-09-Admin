...
<div class="grid grid-cols-2 mb-5">
    <div class="col-span-1">
        <div class="max-w-xs">
            <!-- Button Tambah -->
            <button type="button"
                class="py-3 px-4 w-max justify-center inline-flex items-center white-space: nowrap; gap-x-2 text-sm 2xl:text-base font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
            ...
            <div class="border overflow-hidden dark:border-neutral-700">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    <thead class="bg-Genoa text-white">
                        <tr>
                            <th scope="col"
                                class="px-6 py-3 text-xs 2xl:text-sm border-r-2 font-medium uppercase dark:text-neutral-500 bg-Genoa">
                                No.</th>
                            <th scope="col"
                                class="px-6 py-3 text-xs 2xl:text-sm border-r-2 font-medium uppercase dark:text-neutral-500 bg-Genoa">
                                Nama Petugas</th>
                            ...
                            <th scope="col"
                                class="px-6 py-3 text-xs 2xl:text-sm font-medium uppercase dark:text-neutral-500 bg-Genoa">
                                Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700 text-center">
                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td
                                class="px-3 py-4 whitespace-nowrap text-sm 2xl:text-base border-r-2 text-gray-800 dark:text-neutral-200">
                            ...
                            <td
                                class="px-3 py-4 text-sm 2xl:text-base border-r-2 text-gray-800 whitespace-nowrap dark:text-neutral-200">
