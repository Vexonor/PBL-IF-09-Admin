...
<div class="grid grid-cols-1 mb-5">
    <div class="col-span-1 flex gap-4 justify-stretch">
        ...
        <div class="max-w-xs">
            <button type="button"
                class="py-3 px-4 w-max justify-center inline-flex items-center gap-x-2 text-sm 2xl:text-base font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none"
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    <thead class="bg-Genoa text-white">
                        <tr>
                            <th scope="col"
                                ...
                                No.</th>
                            <th scope="col"
                                class="px-6 py-3 text-xs 2xl:text-sm border-r-2 uppercase dark:text-neutral-500">
                                Nama Petugas</th>
                            <th scope="col"
                                class="px-6 py-3 text-xs 2xl:text-sm border-r-2 uppercase dark:text-neutral-500">
                                Wilayah Bertugas</th>
                            <th scope="col"
                                class="px-4 py-3 text-xs 2xl:text-sm border-r-2 uppercase dark:text-neutral-500">
                                No. Telepon</th>
                            <th scope="col"
                                class="px-6 py-3 text-xs 2xl:text-sm border-r-2 uppercase dark:text-neutral-500">
                                Status</th>
                            <th scope="col" class="px-6 py-3 text-xs 2xl:text-sm uppercase dark:text-neutral-500">
                                Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700 text-center">
                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td
                                class="px-4 py-4 text-sm 2xl:text-base border-r-2 text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                {{ $User->Wilayah_Bertugas }}
                            </td>
                            <td
                                class="px-6 py-4 text-sm 2xl:text-base border-r-2 text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                {{ $User->UserTable->No_Telp }}
                            </td>
                            <td
                                class="px-6 py-4 text-sm 2xl:text-base border-r-2 text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                ...
                                @elseif ($User->Status_Keaktifan === 'Izin')
                                <span
                                ...
                                @elseif($User->Status_Keaktifan === 'Cuti')
                                <span
