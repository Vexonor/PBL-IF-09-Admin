...
@section('main')
<!-- Card Grid -->
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center mx-6">
    <!-- Card 1 -->
    <div class="flex flex-col p-7 bg-white md:rounded-2xl shadow-md border border-gray-200">
    ...
    <!-- Card 2 -->
    <div class="flex flex-col p-7 bg-white md:rounded-2xl shadow-md border border-gray-200">
        <h4 class="text-gray-500 mb-1 whitespace-nowrap">informasi Pengangkutan</h4>
    ...
    <!-- Card 3 -->
    <div class="flex flex-col p-7 bg-white md:rounded-2xl shadow-md border border-gray-200">
        <h4 class="text-gray-500 mb-1">Lokasi TPS</h4>
        ...
        <div class="flex items-center">
            <a href="/lokasiTPS" class="text-Genoa underline hover:text-green-900 text-sm ml-28">
                Lihat Lokasi
            </a>
        </div>
    </div>
    ...
    <!-- Card 4 -->
    <div class="flex flex-col p-7 bg-white md:rounded-2xl shadow-md border border-gray-200">
        <h4 class="text-gray-500 mb-1">Lokasi Bank Sampah
            <div class="flex items-center gap-x-2 mb-2">
                <p data-hs-toggle-count='{
          "target": "#toggle-count",
          "min": 0,
          "max": 150
            ...
            <div class="flex items-center">
                <a href="/bankSampah" class="text-Genoa underline hover:text-green-900 text-sm ml-28">
                    Lihat Lokasi
                </a>
            </div>
    </div>
    ...
    <!-- Card 5 -->
    <div
        class="flex flex-col p-7 bg-white md:rounded-2xl shadow-md border justify-center border-gray-200 lg:col-start-2">
        <h4 class="text-gray-500 mb-1">Admin
            <div class="flex items-center gap-x-2 mb-2">
                <p data-hs-toggle-count='{
          "target": "#toggle-count",
          "min": 0,
          "max": 150
            ...
            <div class="flex items-center">
                <a href="/admin" class="text-Genoa underline hover:text-green-900 text-sm ml-28">
                    Lihat Akun
                </a>
            </div>
    </div>
    ...
    <!-- Card 6 -->
    <div class="flex flex-col p-7 bg-white md:rounded-2xl shadow-md border border-gray-200">
        <h4 class="text-gray-500 mb-1">Petugas Kebersihan
            <div class="flex items-center gap-x-2 mb-2">
                <p data-hs-toggle-count='{
          "target": "#toggle-count",
          "min": 0,
          "max": 150
            ...
            <div class="flex items-center">
                <a href="/petugasKebersihan" class="text-Genoa underline hover:text-green-900 text-sm ml-28">
                    Lihat Akun
                </a>
            </div>
    </div>
