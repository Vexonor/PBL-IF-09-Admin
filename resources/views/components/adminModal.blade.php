                    ...
                    <form action="{{ route('admin.update', ['ID_User' => $User -> ID_User]) }}" method="post">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <input type="text" id="input-label" name="Nama"
                                ...
                                placeholder="Masukkan Nama Lengkap" value="{{ $User->Nama }}" required>
                        </div>
                        <!-- Tanggal Lahir -->
                        <div class="w-full mb-5">
                            ...
                            <input type="date" id="input-label" name="Tanggal_Lahir"
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="Masukkan Nama Lengkap" value="{{ $User->Tanggal_Lahir }}" required>
                        </div>
                        <!-- Jenis Kelamin -->
                        <div class="w-full mb-5">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <textarea id="textarea-label"
                                ...
                                rows="3" placeholder="Alamat" name="Alamat" required>{{ $User->Alamat }}</textarea>
                        </div>
                        <!-- No. Telepon -->
                        <div class="w-full mb-5">
                            ...
                            <input type="text" id="input-label" name="No_Telp"
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="Masukkan No. Telepon" value="{{ $User->No_Telp }}" required>
                        </div>
                        <!-- Email -->
                        <div class="w-full mb-5">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <div class="relative">
                                <input id="editPass{{ $User->ID_User }}" type="password" name="password"
                        ...
                        <div class="w-full mb-5">
                            ...
                            <select name="Role_Admin"
                                ...
                                <option value="Master"
                                    {{ $User->AdminTable->Role_Admin == 'Master' ? 'selected' : '' }}>Master
                                    Admin</option>
                                <option value="Admin" {{ $User->AdminTable->Role_Admin == 'Admin' ? 'selected' : '' }}>
                                    Admin</option>
                            </select>
                        </div>
                </div>
                    ...
                    <form action="">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <input type="text" id="input-label"
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="Masukkan Nama Lengkap" value="{{ $User->Nama }}" readonly>
                        </div>
                        <!-- Tanggal Lahir -->
                        <div class="w-full mb-5">
                            <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Tanggal
                            ...
                            <input type="date" id="input-label"
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="Masukkan Nama Lengkap" value="{{ $User->Tanggal_Lahir }}" readonly>
                        </div>
                        <!-- Jenis Kelamin -->
                        <div class="w-full mb-5">
                            <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Jenis
                        ...
                        <div class="w-full mb-5">
                            ...
                            <textarea id="textarea-label"
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus-within:outline-none disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                rows="3" placeholder="Alamat" readonly>{{ $User->Alamat }}</textarea>
                        </div>
                        <!-- No. Telepon -->
                        <div class="w-full mb-5">
                            <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">No. Telepon
                            ...
                            <input type="text" id="input-label"
                                class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="Masukkan No. Telepon" value="{{ $User->No_Telp }}" readonly>
                        </div>
                        <!-- Email -->
                        <div class="w-full mb-5">
                            <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Email
                        ...
                        <div class="w-full mb-5">
                            ...
                            <select data-hs-select='{
                                ...
                                <option value="" disabled>Pilih</option>
                                <option
                                    value="{{ $User->AdminTable->Role_Admin === 'Master' ||$User->AdminTable->Role_Admin === 'Admin' ? 'selected' : '' }}">
                                    {{ $User->AdminTable->Role_Admin === 'Master' ||$User->AdminTable->Role_Admin === 'Admin' ? $User->AdminTable->Role_Admin : '' }}
                                </option>
                            </select>
                        </div>
                    </form>
