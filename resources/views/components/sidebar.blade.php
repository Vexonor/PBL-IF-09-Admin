<div class="sidebar md:w-64 xl:w-[21.875rem] overflow-hidden">
    <ul>
        ...
        <div class="Menulist">
            ...
            <li class="{{ $title == 'Laporan' ? 'active' : '' }}">
                <a href="/laporan">
                    <div class="icon">
                        <svg class="{{ $title == 'Laporan' ? 'text-black' : 'text-white' }}"
                            xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                            <path
                    ...
                    <div
                        class="text md:text-sm xl:text-md font-medium {{ $title == 'Laporan' ? 'text-black' : 'text-white' }}">
                        Laporan
                    </div>
                </a>
            </li>
