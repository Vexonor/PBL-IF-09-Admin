            ...
            <div class="border overflow-hidden dark:border-neutral-700">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-center #detail-modaltext-sm font-medium text-gray-800 dark:text-neutral-200">
                                User 1</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-800 dark:text-neutral-200">
                                Pengangkutan Sampah</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-800 dark:text-neutral-200"><span class="inline-flex border-2 border-Genoa items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-Aquamarine text-Genoa dark:bg-blue-800/30 dark:text-blue-500">
...
<h2 class="text-2xl text-center my-10 font-semibold dark:text-white">Penanggung Jawab Laporan</h2>


<!-- Table 2 -->
<button type="button" class="py-3 px-4 my-5 w-68 justify-center inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-Genoa text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-large-modal" data-hs-overlay="#tambah-modal">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-800 dark:text-neutral-200">
                                User 1</td>
                            <td class="px-6 py-4 whihtespace-nowrap text-center text-sm text-gray-800 dark:text-neutral-200"><span class="inline-flex border-2 border-Genoa items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-Aquamarine text-Genoa dark:bg-blue-800/30 dark:text-blue-500">
                                    <span class="size-1.5 inline-block rounded-lg bg-Genoa  dark:bg-blue-500"></span>
                                    Selesai
                                </span></td>
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-large-modal" data-hs-overlay="#edit-modal2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#000000" viewBox="0 0 256 256">
                                        <path d="M227.32,73.37,182.63,28.69a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H216a8,8,0,0,0,0-16H115.32l112-112A16,16,0,0,0,227.32,73.37ZM92.69,208H48V163.31l88-88L180.69,120ZM192,108.69,147.32,64l24-24L216,84.69Z">
                                        </path>
                                    </svg>
                                </button>
                                <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-vertically-centered-scrollable-modal" data-hs-overlay="#hapus-modal2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#000000" viewBox="0 0 256 256">
                                        <path d="M216,48H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM192,208H64V64H192ZM80,24a8,8,0,0,1,8-8h80a8,8,0,0,1,0,16H88A8,8,0,0,1,80,24Z">
                                        </path>
                                    </svg>
                                </button>
                                <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-vertically-centered-scrollable-modal" data-hs-overlay="#detail-modal2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#000000" viewBox="0 0 256 256">
                                        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm12-88a12,12,0,1,1-12-12A12,12,0,0,1,140,128Zm44,0a12,12,0,1,1-12-12A12,12,0,0,1,184,128Zm-88,0a12,12,0,1,1-12-12A12,12,0,0,1,96,128Z">
                                        </path>
                                    </svg>
    ...
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-4xl sm:w-full m-3 sm:mx-auto h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
        <div class="w-full max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div class="flex justify-between items-center py-3 px-4 ">
                <h3 id="hs-vertically-centered-scrollable-modal-label" class="font-bold text-2xl font-poppins text-gray-800 dark:text-white mx-auto">
                    Detail Laporan
                </h3>
                ...
                <div class="space-y-4">
                    <form action="">
                        ...
                        <div class="w-full mb-5">
                            <label for="input-label" class="block text-lg font-medium mb-2 dark:text-white">
                                Kategori Laporan :</label>
                            <div class="flex flex-wrap max-w-lg mt-2">
                                <div class="flex w-1/2">
                                    ...
                                    <label for="hs-default-radio" class="text-sm text-black ms-2 dark:text-neutral-400">Pengangkutan Sampah</label>
                                </div>
                                <div class="flex w-1/2 ml-[-40px]">
                                    <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-checked-radio">
                                    <label for="hs-checked-radio" class="text-sm text-black ms-2 dark:text-neutral-400">Kondisi TPS</label>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap max-w-lg mt-2">
                                <div class="flex w-1/2">
                                    <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-default-radio">
                                    <label for="hs-default-radio" class="text-sm text-black ms-2 dark:text-neutral-400">Tempat Sampah Liar</label>
                                </div>
                                <div class="flex w-1/2 ml-[-40px]">
                                    <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-checked-radio">
                                    <label for="hs-checked-radio" class="text-sm text-black ms-1.5 dark:text-neutral-400">Lainnya</label>
                                </div>
                            </div>
                            <!-- Kategori -->
                            <!-- Deskripsi Laporan -->
                            <div class="w-full mb-5">
                                <label for="input-label" class="block text-lg font-medium mt-4 dark:text-white">
                                    Deskripsi Laporan :</label>
                                <textarea class="py-3 px-4 block w-full border-2 border-slate-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" rows="5">Saya ingin melaporkan keterlambatan pemungutan sampah di Perumahan Griya Asri, Blok C. Sampah di area ini sudah menumpuk selama 4 hari sejak jadwal pemungutan terakhir, dan belum ada tindakan pengangkutan hingga saat ini. Akibat penumpukan tersebut, lingkungan sekitar menjadi berbau tidak sedap dan berpotensi mengundang hama seperti tikus dan lalat. Mohon tindak lanjut segera agar masalah ini bisa diatasi sebelum kondisi memburuk.</textarea>
                                <!-- Deskripsi Laporan -->
                                <!-- Titik Koordinat -->
                                <div class="w-full mb-5">
                                    <label for="input-label" class="block text-lg font-medium mt-4 dark:text-white">
                                        Titik Koordinat :</label>
                                    <textarea class="py-1 px-4 block w-full border-2 border-slate-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" rows="5">-7.8953785, 542.8593966</textarea>
                                    <!-- Titik Koordinat -->
                                    <!-- Dokumen Pendukung -->
                                    <div class="w-full mb-5">
                                        <label for="input-label" class="block text-lg font-medium mt-4 dark:text-white">
                                            Dokumen Pendukung :</label>
                                        <img class="w-56 h-auto" src="{{ asset('img/dokumenpendukung.jpg') }}" alt="Dokumen Pendukung">
                                        <!-- Dokumen Pendukung -->
                                        <!-- Status Pengangkutan -->
                                        <div class="w-full mb-5">
                                            <label for="input-label" class="block text-lg font-medium mt-4 dark:text-white">
                                                Status Pengangkutan :</label>
                    ...
                    <form action="">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <div class="flex flex-wrap max-w-lg mt-2">
                                <div class="flex w-1/2">
                                    <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-default-radio" checked="">
                                    <label for="hs-default-radio" class="text-sm text-gray-500 ms-2 dark:text-neutral-400">Pengangkutan Sampah</label>
                                </div>
                                <div class="flex w-1/2 ml-[-40px]">
                                    <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-checked-radio">
                                    <label for="hs-checked-radio" class="text-sm text-gray-500 ms-2 dark:text-neutral-400">Kondisi TPS</label>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap max-w-lg mt-2">
                                <div class="flex w-1/2">
                                    <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-default-radio">
                                    <label for="hs-default-radio" class="text-sm text-gray-500 ms-2 dark:text-neutral-400">Tempat Sampah Liar</label>
                                </div>
                                <div class="flex w-1/2 ml-[-40px]">
                                    <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-checked-radio">
                                    <label for="hs-checked-radio" class="text-sm text-gray-500 ms-1.5 dark:text-neutral-400">Lainnya</label>
                                </div>
                            </div>
                            <!-- Kategori -->
                            <!-- Deskripsi Laporan -->
        ...
        <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <ul class="flex justify-center items-center gap-4 my-10">
                    ...
                    <li><button type="button" class="w-32 py-3 px-4 justify-center inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-Brick-Red text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 256 256">
...
<!-- Detail laporan -->
<div id="detail-modal2" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-large-modal-label">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-4xl sm:w-full m-3 sm:mx-auto h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
        <div class="w-full max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div class="flex justify-between items-center py-3 px-4 ">
                <h3 id="hs-vertically-centered-scrollable-modal-label" class="font-bold text-2xl font-poppins text-gray-800 dark:text-white mx-auto">
                ...
                <button type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600" aria-label="Close" data-hs-overlay="#detail-modal2">
                    <span class="sr-only">Close</span>
                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M18 6 6 18"></path>
                        <path d="m6 6 12 12"></path>
