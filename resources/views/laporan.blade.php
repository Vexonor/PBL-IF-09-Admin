                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700 text-center">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200"><span class="inline-flex border-2 border-Genoa items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-Aquamarine text-Genoa dark:bg-blue-800/30 dark:text-blue-500">
...
<div id="edit-modal" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-large-modal-label">
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="flex flex-wrap max-w-lg mt-2">
                        ...
                        <div class="flex w-1/2 ml-[-40px]">
                            <input type="radio" name="hs-default-radio" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-checked-radio">
                            <label for="hs-checked-radio" class="text-sm text-gray-500 ms-1.5 dark:text-neutral-400">Kondisi TPS</label>
                        </div>
                    </div>
                    <div class="flex flex-wrap max-w-lg mt-2">
                        <div class="flex w-1/2">
                    ...
                    <div class="w-full mt-5">
                        ...
                        <div class="w-full mt-5">
                            ...
                            <!-- Dokumen Pendukung -->
                            <div class="w-full mt-5">
                                <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Dokumen
                                    Pendukung :</label>
                                ...
                                <!-- Status Pengangkutan -->
                        <div class="w-full mt-5">
                            <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Status Pengangkutan :</label>
                        ...
                        <div class="p-4 overflow-y-auto">
                            <div class="space-y-4">
                                ...
                                <div class="w-full mb-5">
                                    ...
                                    <!-- Kategori Laporan -->
                                    <div class="w-full mt-5">
                                        <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Kategori Laporan :</label>
  ...
  "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"shrink-0 size-3.5 text-gray-500 dark:text-neutral-500 \" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
                                        ...
                                        <!-- Titik Koordinat -->
                                        <div class="w-full mt-5">
                                            <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Titik Koordinat :</label>
                                            <div class="max-w-sm space-y-3">
                                                <input type="text" class="py-3 ps-4 pe-9 block w-full border-2 border-slate-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Masukkan Titik Koordinat">
                                            </div>
                                            <!-- Titik Koordinat-->
                ...
                <div class="flex items-center justify-end px-4 py-3 border-t gap-x-2 dark:border-neutral-700">
                    ...
                    <button type="button"
                        ...
                        Simpan
                                            ...
                                            <!-- Status Pengerjaan -->
                                            <div class="w-full mt-5">
                                                <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">Status Pengerjaan :</label>
                                                <div class="flex gap-x-2">
                                                    <div class="flex items-center gap-x-1">
                                                        <input type="radio" name="hs-radio-group" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-radio-group-3">
                                                        <label for="hs-radio-group-3" class="text-sm text-gray-500 dark:text-neutral-400">
